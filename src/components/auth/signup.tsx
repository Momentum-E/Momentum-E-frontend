          ...
          <div className="isolate px-6 py-24 sm:py-32 lg:px-8">
            ...
            <form
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                {/* <div className='bg-me-green-100'>
                  <p className='block text-sm font-semibold leading-6 text-center text-black'>
                    The username once submitted cannot be changed!  
                  </p>  
                </div>    */}
                  ...
                  <div className="flex h-6 items-center">
                    <Switch
                      ...
                      <span
                        aria-hidden="true"
                        className={classNames(
                          agreed ? 'translate-x-3.5 bg-white-100 ' : 'translate-x-0 bg-me-green-100 ',
