...
type vehicleDataComponentProps = {
  vehicleId:string|any;
}

function VehicleData({vehicleId}:vehicleDataComponentProps) {
  ...
  return (
    ...
    : 
    (
      <h1 className='text-white-100 flex items-center justify-center'>
        Select vehicle to view statistics
      </h1>
    )
    }
    </div>
