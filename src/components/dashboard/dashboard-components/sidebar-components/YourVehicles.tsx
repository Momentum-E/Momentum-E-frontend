        ...
        <div className="flex flex-col items-center h-full space-y-2">
            {
                ...
                (
                    <div
                        className="whitespace-pre flex flex-col text-left w-full gap-1 p-1 h-[46%] md:h-[50%]
                        ...
                        (
                            vehicleData.map((data) => (
                                <Disclosure key={data.id}> 
                                {
                                    ...
                                    <>
                                        <div
                                        className={`${page===data.information.vin ? `active `:` `} group dark:text-white-100 link flex justify-between md:justify-start`}>
                                            <button
