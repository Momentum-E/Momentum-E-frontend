...
const ItemCard: React.FC<ItemCardProps> = ({ 
  ...
  return (
    <div className="py-10 w-60 md:border-none border border-me-green-200">  
      ...
      <div className="text-me-green-200 font-bold text-2xl text-center py-5 flex justify-center">
        {heading}
      </div>
