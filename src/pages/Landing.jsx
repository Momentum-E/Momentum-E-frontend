                ...
                <div className="relative group flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 group flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-blueGray-500">
                      If you want to understand your car better battery and 
                      it's performance better.
                    </p>
                    <Link 
                      to='individual-owner'
              ...
              <div className="w-full md:w-4/12 px-4 text-center">
                <div className="relative group flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-blueGray-500">
                      If you are an EV fleet owner and want to reduce your 
                      battery repair and maintainence cost.   
                    </p>
                    <Link 
                      to='fleet-owner'
                      className='flex items-center justify-center '
              ...
              <div className="pt-6 w-full md:w-4/12 px-4 text-center group">
                <div className="relative group flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Battery Rocomposition</h6>
                    <p className="mt-2 mb-4 text-blueGray-500">
                      Write a few lines about each one. A paragraph describing a
                      feature will be enough. Keep you user engaged!
                    </p>
                    <Link 
                      to='battery-recompositon'
                      className='flex items-center justify-center '
                    >  
                      <button className='font-bold p-3 rounded-md flex hover:text-white hover:bg-gray-800'>
                        Learn More 
