...
import logo from '../assets/logos/logo_black_nocap.png'
...
//     <>
//     {/* <!-- Sidebar --> */}
// <aside class="ml-[-100%] fixed z-10 overflow-hidden top-0 pb-3 w-full flex flex-col justify-between h-full border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
//     <div>
//         <div class="pt-2 px-4">
//             <img src={logo} class="" alt="Momentum-E"/>
//         </div>
...
//             <ul class="space-y-2 overflow-y-scroll px-4 tracking-wide mt-5">
//             <li>
...
//                         </svg>
//                         <span class="-mr-1 font-medium">Vehicle1</span>
//                     </a>
//                 </li><li>
//                     <a href="#" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
//                         <svg class="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
