    ...
    <div className='relative'>
      <div className='flex'>
        ...
        <div className="max-w-full flex-1 h-screen overflow-hidden">
          ...
          <>
            {children}
            <div className="flex absolute bottom right-6 bottom-2 translate-x-1/2 translate-y-1/2 bg-white-100 dark:bg-gray-900 border border-gray-900 dark:border-white-100 rounded-full md:order-2">
