...
describe('Home Page', () => {
  ...
  it('should display the login form', () => {
    cy.get('[data-testid="login-nav"]').click();
  ...
  it('should navigate to the pricing page', () => {
    cy.get('[data-testid="pricing-nav"]').click();
    // if (cy.url().includes('http://localhost:3000/pricing')) {
    //   cy.url().should('include', 'http://localhost:3000/pricing');
    //   cy.wait(3000)
  ...
  it('should display the register form', () => {
    cy.get('[data-testid="register-nav"]').click();
